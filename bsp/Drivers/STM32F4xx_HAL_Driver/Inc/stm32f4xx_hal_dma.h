...
#include "stm32f4xx_hal_def.h"
    ...
    typedef struct
    {
        uint32_t Channel; /*!< Specifies the channel used for the specified
        ...
        uint32_t
            PeriphInc; /*!< Specifies whether the Peripheral address register
        ...
        uint32_t FIFOMode; /*!< Specifies if the FIFO mode or Direct mode will
        ...
        uint32_t
            MemBurst; /*!< Specifies the Burst transfer configuration for the
        ...
        uint32_t PeriphBurst; /*!< Specifies the Burst transfer configuration
                                 for the peripheral transfers. It specifies the
                                 amount of data to be transferred in a single
                                 non interruptible transaction. This parameter
...
#include "stm32f4xx_hal_dma_ex.h"
    ...
    /** @defgroup DMA_Exported_Functions_Group1 Initialization and
