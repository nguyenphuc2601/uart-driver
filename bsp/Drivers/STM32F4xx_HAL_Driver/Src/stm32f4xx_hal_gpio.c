            ...
            if (iocurrent == ioposition)
                {
                    ...
                    if (((GPIO_Init->Mode & GPIO_MODE) == MODE_OUTPUT)
                        || (GPIO_Init->Mode & GPIO_MODE) == MODE_AF)
                        {
                            ...
                            temp = GPIOx->OSPEEDR;
                            temp
                                &= ~(GPIO_OSPEEDER_OSPEEDR0 << (position * 2U));
                    ...
                    if ((GPIO_Init->Mode & GPIO_MODE) != MODE_ANALOG)
                        {
                            ...
                            /* Activate the Pull-up or Pull down resistor for
                             * the current IO */
                            temp = GPIOx->PUPDR;
                    ...
                    if ((GPIO_Init->Mode & GPIO_MODE) == MODE_AF)
                        {
                            ...
                            /* Configure Alternate function mapped with the
                             * current IO */
                    ...
                    /* Configure IO Direction mode (Input, Output, Alternate or
                     * Analog) */
                    temp = GPIOx->MODER;
                     ...
                     * ------------------------*/
                    /* Configure the External Interrupt or event for the current
                     * IO */
            ...
            if (iocurrent == ioposition)
                {
                    ...
                    /* Deactivate the Pull-up and Pull-down resistor for the
                     * current IO */
